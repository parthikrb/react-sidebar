import React, { Component as Component$1, useState, useEffect, createContext, createElement, useCallback, useContext as useContext$1, useRef, Fragment as Fragment$1, cloneElement, forwardRef as forwardRef$2, useMemo, Children, isValidElement, useLayoutEffect } from 'react';
...
function useVariantContext() {
    return useContext$1(MotionContext).variantContext;
}
function useVisualElementContext() {
    return useContext$1(MotionContext).visualElement;
}
...
var useDomVisualElement = function (Component, props, isStatic, ref) {
    ...
    var layoutGroupId = useContext$1(LayoutGroupContext);
    visualElement.layoutId =
        layoutGroupId && props.layoutId
            ? layoutGroupId + "-" + props.layoutId
            : props.layoutId;
    var presenceContext = useContext$1(PresenceContext);
    /**
...
function usePanGesture(_a, ref) {
    ...
    var transformPagePoint = useContext$1(MotionConfigContext).transformPagePoint;
    var handlers = {
...
function useFeatures(defaultFeatures, isStatic, visualElement, props) {
    var plugins = useContext$1(MotionConfigContext);
...
function useSnapshotOnUnmount(visualElement) {
    var syncLayout = useContext$1(SharedLayoutContext);
    var framerSyncLayout = useContext$1(FramerTreeLayoutContext);
...
function usePresence() {
    var context = useContext$1(PresenceContext);
    if (context === null)
        return [true, null];
...
function createMotionComponent(Component, _a) {
    ...
    function MotionComponent(props, externalRef) {
         ...
         */
        var isStatic = useContext$1(MotionConfigContext).isStatic;
        /**
    ...
    return forwardRef$2(MotionComponent);
}
...
var AnimatePresence = function (_a) {
    ...
    var layoutContext = useContext$1(SharedLayoutContext);
    ...
    if (isInitialRender.current) {
        isInitialRender.current = false;
        return (createElement(Fragment$1, null, filteredChildren.map(function (child) { return (createElement(PresenceChild, { key: getChildKey(child), isPresent: true, initial: initial ? undefined : false, presenceAffectsLayout: presenceAffectsLayout }, child)); })));
    }
...
var BrandContainer = styled.div(_templateObject());
var Brand = styled(motion.div)(_templateObject2(), function (props) {
  return props.shouldDisplay ? 'block' : 'none';
});
var BrandLogo = styled.img(_templateObject3(), function (props) {
  return props.src;
});
...
var Header = function Header(_ref) {
  ...
  return /*#__PURE__*/React.createElement(AnimatePresence, null, /*#__PURE__*/React.createElement(BrandContainer, null, shouldExpand ? !!brandName.logoPath ? /*#__PURE__*/React.createElement(Fragment$1, null, /*#__PURE__*/React.createElement(BrandLogo, {
    ...
    animate: "show",
    exit: "hidden"
  }, brandName.name)) : /*#__PURE__*/React.createElement(Brand, {
    shouldDisplay: shouldExpand,
    layout: true,
    variants: titleVariants,
    initial: "hidden",
    animate: "show",
    exit: "hidden"
  }, brandName.name) : !!brandName.logoPath ? /*#__PURE__*/React.createElement(BrandLogo, {
    src: brandName.logoPath
  }) : /*#__PURE__*/React.createElement(Brand, {
    shouldDisplay: !shouldExpand,
    layout: true,
...
var SidebarDrawer = styled(motion.div)(_templateObject$1());
var MenuContainer = styled(motion.div)(_templateObject2$1());
var MenuItem = styled(NavLink)(_templateObject3$1(), function (props) {
  return props.selected ? '#1abc9c' : '#bdc3c7';
});
var MainMenu = styled(motion.div)(_templateObject4(), function (props) {
  return !props.expanded && css(_templateObject5());
}, function (props) {
  return props.selected ? '#1dd1a1' : '#ecf0f1';
});
var MenuName = styled(motion.div)(_templateObject6(), function (props) {
  return props.shouldExpand ? 'block' : 'none';
});
var MenuIcon = styled.div(_templateObject7(), function (props) {
  return !props.shouldExpand && '0 auto';
}, function (props) {
  return props.shouldExpand && '20px';
}, function (props) {
  return props.shouldExpand ? '30px' : 'auto';
});
var SubMenu = styled(NavLink)(_templateObject8());
var SubMenuItem = styled(motion.div)(_templateObject9(), function (props) {
  return props.selected ? '#1abc9c' : '#bdc3c7';
}, function (props) {
  return props.selected ? '#1dd1a1' : '#ecf0f1';
});
var DropDownIcon = styled.span(_templateObject10(), function (props) {
  return props.open ? 'rotate(-135deg)' : 'rotate(45deg)';
}, function (props) {
  return props.open ? '18px' : '19px';
});
var Toggle = styled.div(_templateObject11());
...
var Sidebar = function Sidebar(props) {
  ...
  var _useState7 = useState(menuList),
  ...
  var handleToggle = function handleToggle() {
    setIsDrawerOpen(function (isDrawerOpen) {
      return !isDrawerOpen;
    });
  };
  ...
  var handleMenuSelection = function handleMenuSelection(index) {
  ...
  var handleMenuClick = function handleMenuClick(index) {
    !index.toString().includes('_') && menuItems[index].hasChildren ? handleExpandMenu(index) : handleMenuSelection(index);
  };

  return /*#__PURE__*/React.createElement(BrowserRouter, null, /*#__PURE__*/React.createElement(AnimateSharedLayout, null, /*#__PURE__*/React.createElement(AnimatePresence, null, /*#__PURE__*/React.createElement(SidebarDrawer, {
    layout: true,
    id: "sidebar",
    ...
    brandName: brandName
  }), menuItems.map(function (mainMenu, index) {
    return /*#__PURE__*/React.createElement(MenuContainer, {
      ...
      shouldExpand: shouldExpand
    }, mainMenu.icon), /*#__PURE__*/React.createElement(MenuName, {
      layout: true,
      shouldExpand: shouldExpand,
      variants: titleVariants,
      initial: "hidden",
      animate: "show",
      exit: "hidden"
    }, mainMenu.name), mainMenu.hasChildren && shouldExpand && /*#__PURE__*/React.createElement(DropDownIcon, {
      open: mainMenu.isOpen || false
    }))), mainMenu.hasChildren && mainMenu.isOpen && mainMenu.subMenu.map(function (subMenuItem, sIndex) {
      return /*#__PURE__*/React.createElement(SubMenu, {
        to: "".concat(mainMenu.to).concat(subMenuItem.to),
        key: sIndex,
        onClick: function onClick() {
          return handleMenuClick("".concat(index, "_").concat(sIndex));
        },
        activeStyle: {
          color: '#1abc9c'
        }
      }, /*#__PURE__*/React.createElement(SubMenuItem, {
        layout: true,
        variants: subTitleVariants,
        ...
        animate: "show",
        exit: "hidden"
      }, subMenuItem.icon && shouldExpand && /*#__PURE__*/React.createElement(MenuIcon, {
        shouldExpand: shouldExpand
      }, subMenuItem.icon), /*#__PURE__*/React.createElement(MenuName, {
        shouldExpand: shouldExpand
      }, subMenuItem.name)));
    }));
