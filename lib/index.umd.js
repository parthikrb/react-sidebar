(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('@fortawesome/react-fontawesome'), require('@fortawesome/free-solid-svg-icons'), require('@emotion/styled'), require('@emotion/react')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', '@fortawesome/react-fontawesome', '@fortawesome/free-solid-svg-icons', '@emotion/styled', '@emotion/react'], factory) :
  (global = global || self, factory(global.reactSampleComponentsLibrary = {}, global.React, global['prop-types'], global['react-fontawesome'], global['free-solid-svg-icons'], global.styled, global['emotion-react']));
}(this, (function (exports, React, PropTypes, reactFontawesome, freeSolidSvgIcons, styled, react) { 'use strict';
  ...
  var SidebarDrawer = styled.div(_templateObject(), function (props) {
    return props.shouldExpand ? '20%' : '5%';
  });
  var BrandContainer = styled.div(_templateObject2());
  var Brand = styled.h3(_templateObject3(), function (props) {
    return props.shouldDisplay ? 'block' : 'none';
  });
  var BrandLogo = styled.img(_templateObject4(), function (props) {
    return props.src;
  });
  var MenuContainer = styled.div(_templateObject5());
  var MenuItem = styled(NavLink)(_templateObject6(), function (props) {
    return props.selected ? '#1abc9c' : '#bdc3c7';
  }, function (props) {
    return !props.expanded && react.css(_templateObject7());
  }, function (props) {
    return props.selected ? '#1dd1a1' : '#ecf0f1';
  });
  var MenuName = styled.p(_templateObject8(), function (props) {
    return props.shouldExpand ? 'block' : 'none';
  });
  var MenuIcon = styled.div(_templateObject9(), function (props) {
  ...
  var SubMenu = styled(NavLink)(_templateObject10(), function (props) {
    return props.selected ? '#1abc9c' : '#bdc3c7';
  }, function (props) {
    return props.selected ? '#1dd1a1' : '#ecf0f1';
  });
  var DropDownIcon = styled.span(_templateObject11(), function (props) {
    return props.open ? 'rotate(-135deg)' : 'rotate(45deg)';
  }, function (props) {
    return props.open ? '18px' : '19px';
  });
  var Toggle = styled.div(_templateObject12());
  ...
  var Sidebar = function Sidebar(props) {
    ...
    return /*#__PURE__*/React__default.createElement(BrowserRouter, null, /*#__PURE__*/React__default.createElement(SidebarDrawer, {
      id: "sidebar",
      shouldExpand: shouldExpand
    }, /*#__PURE__*/React__default.createElement(BrandContainer, null, shouldExpand && !brandName.logoPath ? /*#__PURE__*/React__default.createElement(Brand, null, brandName.name) : /*#__PURE__*/React__default.createElement(React.Fragment, null, /*#__PURE__*/React__default.createElement(BrandLogo, {
      src: brandName.logoPath
    }), /*#__PURE__*/React__default.createElement(Brand, {
      shouldDisplay: shouldExpand
    }, brandName.name))), menuItems.map(function (mainMenu, index) {
